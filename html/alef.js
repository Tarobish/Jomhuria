...
require([
  ...
  , typoStuff
    ...
    function main() {
        ...
        for(ii=0,ll=alefs.length;ii<ll;ii++) {
                alef = alefs[ii];
            rows.push(createElement('tr', {dir:'LTR'},
                createElement('th', {colspan: (first.length + 1)}, 'Alef: ' + alef.name)));
        ...
        body.appendChild(createElement('table', {dir: 'LTR'}, rows));
    }
