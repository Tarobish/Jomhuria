...
\setmainfont[Path=./document-sources/fonts/CharisSIL-5.000/, Ligatures=TeX]{CharisSIL-B.ttf}  % Set the default font for the document. = \setdefaultfont
...
\newfontfamily\arabicfont[Path=./generated/, Script=Arabic, Scale=2]{Jomhuria-Regular.ttf} % Arabic transcription -- coloured black, double size.
...
\newcommand\Atitle[1]{{\fontspec[Path=./generated/, Script=Arabic, Scale=5]{Jomhuria-Regular.ttf}\RLE{#1}}}  % Arabic transcription for titles - uses a version of Granada which has been extended to include glyphs for Swahili.

\newcommand\Tr[1]{{\fontspec[Path=./document-sources/fonts/Biolinum/, Scale=1, Color=666666]{LinBiolinum_R.otf}#1}}   %  Transliteration -- Biolinum handles diacritics well.  Coloured grey, slightly less than normal size.

\newcommand\OLTst[1]{{\fontspec[Path=./document-sources/fonts/Biolinum/, Color=333333, Scale=1]{LinBiolinum_R.otf}#1}}  % Standard spelling -- normal size.
